...
- Create Angular project with ng: `ng new sfa-chat-graph.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`sfa-chat-graph.client.esproj`).
